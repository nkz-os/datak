...
class TestAuthEndpoints:
    ...
    async def test_login_success(self, async_client: AsyncClient, test_user):  # noqa: ARG002
    ...
    async def test_login_invalid_password(self, async_client: AsyncClient, test_user):  # noqa: ARG002
        response = await async_client.post(
            "/api/auth/login",
